...
module.exports = async ({getNamedAccounts, deployments}) => {
  ...
  // LOCKED_DAO_TOKENS: "5000000000",            // 5 Billion RANDOM (50%)    - locked and released gradually in 5 years
  // TOTAL_NO_LOSS_LOTTERY_TOKENS: "2500000000", // 2.5 Billion RANDOM (25%)  - locked and released gradually in 10 years
  // TOTAL_CONTRIBUTOR_TOKENS: "1000000000",     // 1 Billion RANDOM (10%)    - locked and released gradually in 5 years
  // TOTAL_STAKING_TOKENS: "750000000",          // 750 Million RANDOM (7.5%) - locked and released gradually in 10 years
  // TOTAL_YIELD_FARMING_TOKENS: "750000000",    // 750 Million RANDOM (7.5%) - locked and released gradually in 10 years    

  if((await TokenLock.lockedAmounts(TimeLock.address)).eq(0)) {

    // Transfer 5B locked RANDOM Tokens to the TokenLock and is fully released in 3 years
    ...
    // Transfer 2.5B locked RANDOM Tokens to the No Loss Lottery Gnosis Treasury (half is rewarded and half is burned over a period of 10 years)
...
module.exports.dependencies = ['RandomizerToken', 'TimeLock', 'TokenLock'];
